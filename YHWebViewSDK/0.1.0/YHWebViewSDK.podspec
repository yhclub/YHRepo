...
TODO: 简单的webview封装.
  ...
  s.homepage         = 'https://www.mstpay.com:1809/ios_component/YHWebViewSDK.git'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'XmYhkj' => 'yhkj_xm@163.com' }
  s.source           = { :git => 'https://www.mstpay.com:1809/ios_component/YHWebViewSDK.git', :tag => s.version.to_s }
