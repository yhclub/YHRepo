...
V1.2.5.1 setChargeNo
V1.2.9.1 处理微信H5支付渠道，调起支付时马上就回到收银台导致收银台无法获取到正确的支付结果。故未知的支付结果需要等待应用再次进入活跃状态时去查询支付结果
...
DESC
  ...
  s.public_header_files = ['YHOnePaySDK/Classes/config/*.{h}','YHOnePaySDK/Classes/YHOnePaySDK.h','YHOnePaySDK/Classes/business/webview/YHOnePayWebVC.h']
