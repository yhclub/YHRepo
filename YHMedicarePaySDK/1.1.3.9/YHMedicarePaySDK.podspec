...
Pod::Spec.new do |s|
    ...
    s.homepage         = 'http://192.168.11.239/ios_component/YHMedicarePaySDK.git'
    # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
    s.license          = { :type => 'MIT', :file => 'LICENSE' }
    s.author           = { 'jagtu' => '42318168@qq.com' }
    s.source           = { :git => 'http://192.168.11.239/ios_component/YHMedicarePaySDK.git', :tag => s.version.to_s }
