...
#  s.public_header_files = ['HSAMPaySDK/Classes/Config/**/*.{h}','HSAMPaySDK/Classes/HSACommon/Base/Config/**/*.h','HSAMPaySDK/Classes/HSACommon/HSA-NetEncryption-iOS/Config/**/*.h']
